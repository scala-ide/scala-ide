...
class BitwiseOrTest extends BaseIntegrationTest(BitwiseOrTest) with DefaultBeforeAfterEach {
...
object BitwiseOrTest extends BaseIntegrationTestCompanion with DefaultBeforeAfterAll
