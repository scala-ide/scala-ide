...
class AdditionTest extends BaseIntegrationTest(AdditionTest) with DefaultBeforeAfterEach {
...
object AdditionTest extends BaseIntegrationTestCompanion with DefaultBeforeAfterAll
