...
class VarargsTest extends BaseIntegrationTest(VarargsTest) {
  ...
  def simpleVararg(): Unit = {
    eval(""" vararg.f("1", "2") """, "s*", Java.boxed.String)
    eval(""" vararg.g(1, "2") """, "i,s*", Java.boxed.String)
    eval(""" vararg.h("1", 2, "3") """, "s,i,s*", Java.boxed.String)
  }

  @Test
  def simpleVarargWithStrangeName(): Unit = {
    eval(""" vararg.f_+("1", "2") """, "s*", Java.boxed.String)
    eval(""" vararg.g_+(1, "2") """, "i,s*", Java.boxed.String)
  }

  @Test
  def simpleVarargWithNoArgs(): Unit = eval(""" vararg.f() """, "s*", Java.boxed.String)

  @Test
  def varargWithOneArgWithNoArgs(): Unit = eval(""" vararg.g(1) """, "i,s*", Java.boxed.String)
  ...
  def argumentAndVararg(): Unit = {
    eval(""" argumentAndVarArg.f("1") """, "s", Java.boxed.String)
    eval(""" argumentAndVarArg.f("1", "2") """, "s,s*", Java.boxed.String)
  }
