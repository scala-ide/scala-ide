...
class CloseCharCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.CloseChar =
    new org.scalaide.extensions.autoedits.CloseChar {
