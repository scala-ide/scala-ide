...
class CloseStringCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.CloseString =
    new org.scalaide.extensions.autoedits.CloseString {
