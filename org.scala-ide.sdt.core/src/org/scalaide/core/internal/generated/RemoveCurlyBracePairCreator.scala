...
class RemoveCurlyBracePairCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.RemoveCurlyBracePair =
    new org.scalaide.extensions.autoedits.RemoveCurlyBracePair {
