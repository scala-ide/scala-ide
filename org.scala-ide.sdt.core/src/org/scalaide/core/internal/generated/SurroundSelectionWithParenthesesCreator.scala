...
class SurroundSelectionWithParenthesesCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.SurroundSelectionWithParentheses =
    new org.scalaide.extensions.autoedits.SurroundSelectionWithParentheses {
