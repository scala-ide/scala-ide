...
class ConvertToUnicodeCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.ConvertToUnicode =
    new org.scalaide.extensions.autoedits.ConvertToUnicode {
