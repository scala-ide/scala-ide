...
class SmartSemicolonInsertionCreator {
  def create(doc: org.scalaide.core.text.Document, change: org.scalaide.core.text.TextChange): org.scalaide.extensions.autoedits.SmartSemicolonInsertion =
    new org.scalaide.extensions.autoedits.SmartSemicolonInsertion {
