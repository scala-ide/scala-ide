...
protected[scalaide] object RefactoringMenu {
  ...
  private object Id {
    ...
    val CommandsCategory = "scala.tools.eclipse.refactoring.commands.refactoring"
    val CommandsMethodSignatureCategory = "scala.tools.eclipse.refactoring.commands.methodsignature"
  }
