 ...
 *
 *  @note This class takes a snapshot of project properties. It will *not* reflect changes that happened
 *        between the moment a property was first accessed, and subsequent read/writes.
 */
