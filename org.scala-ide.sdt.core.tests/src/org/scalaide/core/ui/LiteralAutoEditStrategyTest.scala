...
class LiteralAutoEditStrategyTest extends AutoEditStrategyTests {
  ...
  @Test
  def auto_close_string_literal(): Unit = {
  ...
  @Test
  def no_auto_close_on_existing_string_literal_before_caret(): Unit = {
    test(input = "\"^", expectedOutput = "\"\"^", operation = Add("\""))
  }

  @Test
  def no_auto_close_on_existing_string_literal_after_caret(): Unit = {
    test(input = "^\"", expectedOutput = "\"^\"", operation = Add("\""))
  }

  @Test
  def auto_close_character_literal(): Unit = {
    test(input = "^", expectedOutput = "'^'", operation = Add("'"))
  }
  ...
  @Test
  def no_auto_close_on_existing_char_literal_before_caret(): Unit = {
    test(input = "'^", expectedOutput = "''^", operation = Add("'"))
  }

  @Test
  def no_auto_close_on_existing_char_literal_after_caret(): Unit = {
    test(input = "^'", expectedOutput = "'^'", operation = Add("'"))
  }
