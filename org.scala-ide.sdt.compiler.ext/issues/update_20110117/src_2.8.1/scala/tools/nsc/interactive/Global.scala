...
import _root_.scala.tools.nsc.io.{AbstractFile, LogReplay, Logger, NullLogger, Replayer}
import _root_.scala.tools.nsc.util.{SourceFile, Position, RangePosition, NoPosition/*, WorkScheduler */}
import _root_.scala.tools.nsc.reporters._
import _root_.scala.tools.nsc.symtab._
import _root_.scala.tools.nsc.ast._
import _root_.scala.tools.nsc.io.Pickler._
...
self =>
  ...
  private def replayName = false //BACK-2.8 settings.YpresentationReplay.value
  private def logName = false //BACK-2.8 settings.YpresentationLog.value
