...
object IDESettings {
  def shownSettings(s : Settings) : List[Settings#Setting]= {
    ...
    List(
      ...
      Xcloselim, Xdce, Xdetach, inline, Xlinearizer, Ynogenericsig, noimports, nopredefs, Yrecursion, selfInAnnots, Xsqueeze, refinementMethodDispatch, nospecialization, Yjenkins,
